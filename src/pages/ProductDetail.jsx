  ...
  return (
    <div className="product-detail-page container animate-fade-in">
      <div className="breadcrumb">
        <Link to="/">Accueil</Link> / <Link to="/collections">Collections</Link>{" "}
      ...
      <div className="product-main">
        ...
        <div className="product-info-panel">
          ...
          <div className="product-description">
            ...
            <p>
              {product.description ||
                `Découvrez le prochain niveau de confort et de style avec la ${product.name}. 
          ...
          <div className="purchase-options">
            <div className="option-group">
              ...
              <div className="size-selector">
                {(product.sizes || "38, 39, 40, 41, 42, 43, 44, 45")
                  .split(",")
                  .map((size) => (
                    <button
                      key={size}
